...
from UI.reportDialog import ReportDialog
from UI.searchDialog import SearchDialog, getAllDicom
...
from UI.checkDialog import CheckDialog
import config
...
from UI.scImageLabel import SCImageLabel
from UI.segDialog import SegDialog
...
class Ui_MainWindow(object):
    ...
    def showImage(self, dicomFile):
        ...
        self.tImage.setFixedSize(config.IMAGE_WIDTH, round(dicomFile.transverseHeight * scale))
        self.sImage.setFixedSize(config.IMAGE_WIDTH, round(dicomFile.longitudinalHeight * scale))
        self.cImage.setFixedSize(config.IMAGE_WIDTH, round(dicomFile.longitudinalHeight * scale))
        self.pImage.setFixedSize(config.IMAGE_WIDTH, round(dicomFile.transverseHeight / 2 * scale * scale))
        self.lImage.setFixedSize(config.IMAGE_WIDTH, round(dicomFile.longitudinalHeight * scale))
